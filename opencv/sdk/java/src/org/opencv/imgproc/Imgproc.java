...
public class Imgproc {
     ...
     * an edge com.nyiit.heartbeat_ncnn.detector output can be used as a mask to stop filling at edges. On output, pixels in the
     ...
     * threshold of the two passed to the Canny edge com.nyiit.heartbeat_ncnn.detector (the lower one is twice smaller).
    ...
    /**
     * Harris corner com.nyiit.heartbeat_ncnn.detector.
     *
     * The function runs the Harris corner com.nyiit.heartbeat_ncnn.detector on the image. Similarly to cornerMinEigenVal and
     ...
     *
     * @param src Input single-channel 8-bit or floating-point image.
     * @param dst Image to store the Harris com.nyiit.heartbeat_ncnn.detector responses. It has the type CV_32FC1 and the same
     * size as src .
     * @param blockSize Neighborhood size (see the details on #cornerEigenValsAndVecs ).
     * @param ksize Aperture parameter for the Sobel operator.
     * @param k Harris com.nyiit.heartbeat_ncnn.detector free parameter. See the formula above.
     * @param borderType Pixel extrapolation method. See #BorderTypes.
     */
     ...
     * @param useHarrisDetector Parameter indicating whether to use a Harris com.nyiit.heartbeat_ncnn.detector (see #cornerHarris)
     * or #cornerMinEigenVal.
     * @param k Free parameter of the Harris com.nyiit.heartbeat_ncnn.detector.
     *
