 ...
 * <ul>
 *   <li>
 *  (Python) A complete example showing the use of the %MSER com.nyiit.heartbeat_ncnn.detector can be found at samples/python/mser.py
 *   </li>
 * </ul>
 */
public class MSER extends Feature2D {
    ...
    /**
     * Full consturctor for %MSER com.nyiit.heartbeat_ncnn.detector
     *
